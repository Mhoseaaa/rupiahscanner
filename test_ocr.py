...
model = YOLO(r"C:\Users\itsho\OneDrive\Dokumen\Semester 4\rupiahscanner\runs\detect\rupiah_detector_v19\weights\best.pt")  # Ganti dengan model yang sudah dilatih untuk uang rupiah
